 ...
 * Note  NDIS 5.x Miniport drivers that conform to the IEEE<sup>Ã”Ã¶Â¼â”¬Â½</sup> 802.11 interface must
...
/*! FDDI is not supported on Windows<sup>Ã”Ã¶Â¼â”¬Â½</sup> Vista.*/
