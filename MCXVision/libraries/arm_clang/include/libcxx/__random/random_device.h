...
public:
  ...
  // constructors
#ifdef __ARMCOMPILER_LIBCXX
#ifndef _LIBCPP_CXX03_LANG
  random_device() : random_device("pseudorandom") {}
  explicit random_device(const string& __token);
#else
  explicit random_device(const string& __token = "pseudorandom");
#endif
#else
#  ifndef _LIBCPP_CXX03_LANG
...
#  endif // __ARMCOMPILER_LIBCXX
  ...
  // property functions
  _LIBCPP_FLOAT_ABI double entropy() const _NOEXCEPT;
