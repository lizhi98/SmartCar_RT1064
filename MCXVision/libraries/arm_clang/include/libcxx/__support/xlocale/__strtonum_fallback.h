...
inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_FLOAT_ABI float
strtof_l(const char *__nptr, char **__endptr, locale_t) {
  return ::strtof(__nptr, __endptr);
}

inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_FLOAT_ABI double
strtod_l(const char *__nptr, char **__endptr, locale_t) {
  return ::strtod(__nptr, __endptr);
}

#if defined(__LIBCPP_HAVE_LONGDOUBLE) /* SDCOMP-28981 */
inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_FLOAT_ABI long double
