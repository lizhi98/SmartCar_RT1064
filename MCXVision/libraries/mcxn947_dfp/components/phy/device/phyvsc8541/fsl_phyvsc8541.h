...
/*****************************************************************************
 * PHY VSC8541 driver change log
 *****************************************************************************/

/*!
@page driver_log Driver Change Log

@section phyvsc8541 PHYVSC8541
  The current PHYVSC8541 driver version is 2.0.0.

  - 2.0.0
    - Initial version.
*/

#ifndef _FSL_PHYVSC8541_H_
#define _FSL_PHYVSC8541_H_
...
typedef struct _phy_vsc8541_resource
{
    mdioWrite write;
    mdioRead read;
    mdioWriteExt writeExt;
    mdioReadExt readExt;
} phy_vsc8541_resource_t;
